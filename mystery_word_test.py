...
class TestMysteryWord(unittest.TestCase):
    ...
    def test_is_guess_too_long(self):
        self.assertFalse(is_guess_too_long('Hello, world.', 'df', guessed_letters))

    def test_is_guess_too_long(self):
        self.assertFalse(is_guess_too_long('Hello, world.', '75', guessed_letters))

    def test_is_guess_too_long(self):
        self.assertTrue(is_guess_too_long('Hello, world.', 'd', guessed_letters))


    def test_has_been_guessed(self):
        self.assertFalse(is_guess_too_long('Hello, world.', 'a', guessed_letters))

    def test_has_been_guessed(self):
        self.assertTrue(is_guess_too_long('Hello, world.', 'd', guessed_letters))


    def test_is_match_in_word(self):
